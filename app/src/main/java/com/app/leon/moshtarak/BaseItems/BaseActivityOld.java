...
public abstract class BaseActivityOld extends AppCompatActivity
    ...
    DrawerLayout drawer;
    ListView drawerList;
    NavigationCustomAdapterOld adapter;
    List<NavigationCustomAdapterOld.DrawerItem> dataList;
    BaseActivityOldBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = BaseActivityOldBinding.inflate(getLayoutInflater());
    ...
    void setOnDrawerItemClick() {
        drawerList.setOnItemClickListener((adapterView, view, position, id) -> {
            ...
            if (position == 0) {
                ...
                new CustomTab(getString(R.string.abfa_site), BaseActivityOld.this);
            } else if (position == 2) {
...
//            binding.imageViewSwitch.setImageDrawable(getDrawable(R.drawable.day_drawer));//TODO
    ...
    void fillDrawerListView() {
        dataList = new NavigationCustomAdapterOld.DrawerItem().convertStringToList(
        ...
        adapter = new NavigationCustomAdapterOld(this, R.layout.item_navigation, dataList);
